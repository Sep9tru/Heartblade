...
import java.util.Random;
   ...
   implements IThrowableEntity
 {
   ...
   protected void entityInit() {
     ...
     getDataWatcher().addObject(27, Float.valueOf(1.0F));
   ...
   public void setColor(int value) {
        /* 114 */     getDataWatcher().updateObject(10, Integer.valueOf(value));
        /*     */   }
   public boolean getIsMultiHit() {
        /* 119 */     return (getDataWatcher().getWatchableObjectByte(4) == 0);
        /*     */   }
   ...
   public void setChangeTime(int value) {
        /* 174 */     getDataWatcher().updateObject(23, Integer.valueOf(value));
        /*     */   }
   public String getSound() {
        /* 179 */     return getDataWatcher().getWatchableObjectString(24);
        /*     */   }
   public void setSound(String value) {
        /* 184 */     getDataWatcher().updateObject(24, String.valueOf(value));
        /*     */   }
   public String getParticle() {
        /* 189 */     return getDataWatcher().getWatchableObjectString(25);
        /*     */   }
   public void setParticle(String value) {
        /* 194 */     getDataWatcher().updateObject(25, String.valueOf(value));
        /*     */   }
   public boolean getIsPlayerSound() {
        /* 199 */     return (getDataWatcher().getWatchableObjectByte(26) == 0);
        /*     */   }
   ...
   public float getScale() {
     return getDataWatcher().getWatchableObjectFloat(27);
   }
   public void setScale(float Color) {
     getDataWatcher().updateObject(27, Float.valueOf(Color));
   }
   ...
   public Entity getThrower() {
        /* 470 */     return this.thrower;
        /*     */   }
   public void setThrower(Entity entity) {
        /* 475 */     this.thrower = entity;
        /*     */   }
