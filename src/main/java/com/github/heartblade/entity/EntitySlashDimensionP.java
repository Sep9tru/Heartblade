 ...
 */
public class EntitySlashDimensionP extends Entity implements IThrowableEntity {
    /**
     * ★撃った人
     */
     ...
     * @param par1World
     */
    public EntitySlashDimensionP(World par1World)
    {
        super(par1World);
        ticksExisted = 0;
    ...
    public EntitySlashDimensionP(World par1World, EntityLivingBase entityLiving, float AttackLevel, boolean multiHit){
        this(par1World, entityLiving, AttackLevel);
        this.setIsSingleHit(multiHit);
    }

    public EntitySlashDimensionP(World par1World, EntityLivingBase entityLiving, float AttackLevel)
    {
        this(par1World);
    ...
    private static final DataParameter<Integer> LIFETIME = EntityDataManager.<Integer>createKey(EntitySlashDimensionP.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> SINGLE_HIT = EntityDataManager.<Boolean>createKey(EntitySlashDimensionP.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> IS_SLASH_DIMENSION = EntityDataManager.<Boolean>createKey(EntitySlashDimensionP.class, DataSerializers.BOOLEAN);

    private static final DataParameter<Integer> THROWER_ENTITY_ID = EntityDataManager.<Integer>createKey(EntitySlashDimensionP.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> INTERVAL = EntityDataManager.<Integer>createKey(EntitySlashDimensionP.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> COLOR = EntityDataManager.<Integer>createKey(EntitySlashDimensionP.class, DataSerializers.VARINT);
