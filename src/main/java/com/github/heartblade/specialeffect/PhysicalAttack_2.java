...
public class PhysicalAttack_2 implements ISpecialEffect {
    static final String EffectKey = "PhysicalAttackS";
    protected int BurstLevel = 20;

    public PhysicalAttack_2() {
    }
    ...
    public void doSpacialAttack(ItemStack stack, EntityPlayer player, ItemSlashBlade.ComboSequence seq) {
        ...
        world.playSoundAtEntity(player, "random.orb", 1.0F, 3.0F);
                ...
                for (int i = 0; i < count; i++) {
                    if (!world.isRemote) {
                        ...
                        if (entityDrive != null) {
                            ...
                            int color = isBurst ? 16777215 : 3092303;
