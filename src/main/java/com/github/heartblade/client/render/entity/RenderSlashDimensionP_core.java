package com.github.heartblade.client.render.entity;
 ...
 */
public class RenderSlashDimensionP_core extends Render{

    static public WavefrontObject model = null;

    static public ResourceLocationRaw modelLocation = new ResourceLocationRaw("flammpfeil.slashblade","model/util/slashdimP.obj");
    static public ResourceLocationRaw textureLocation = new ResourceLocationRaw("flammpfeil.slashblade","model/util/slashdimP.png");

    public RenderSlashDimensionP_core(RenderManager renderManager) {
        super(renderManager);
    }
