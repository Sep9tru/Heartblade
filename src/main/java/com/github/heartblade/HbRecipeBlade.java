 ...
 */
public class HbRecipeBlade extends ShapedOreRecipe {
    ...
    public HbRecipeBlade(ResourceLocation group, ItemStack result, ItemStack inheritBlade, Object... recipe) {
     ...
     * @param recipe 合成
     */
    public HbRecipeBlade(ResourceLocation group, ItemStack result, ItemStack inheritBlade, List<ItemStack> materialBlade, Object... recipe) {
                ...
                if (!materialBlade.isEmpty()){
                    for(int idx = 0; idx < inv.getSizeInventory(); idx++){
                        ...
                        if (!curIs.isEmpty() && curIs.getItem() instanceof ItemSlashBlade && curIs.hasTagCompound() && !determineBlade.contains(curIs)){
                            ...
                            boolean determine = !curIs.getDisplayName().equals(materialBlade.getDisplayName()) ||
